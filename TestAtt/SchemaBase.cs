...
namespace BimIshou.TestAtt
{
    public abstract class SchemaBase
    {
        ...
        private SchemaCustomAttribute _schema;
        private MethodInfo _entityGet;
        private MethodInfo _entitySet;

        private SchemaCustomAttribute SchemaDefinition
        {
            get
            {
                if (null == _schema)
                {
                    var schemaDefinition =
                        GetType()
                            .GetCustomAttributes(typeof(SchemaCustomAttribute), false)
                            .Cast<SchemaCustomAttribute>()
                            .FirstOrDefault();
